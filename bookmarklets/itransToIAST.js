javascript:(
  function(){
    ...
    /* https://stackoverflow.com/questions/5393922/javascript-replace-selection-all-browsers */
    /* https://stackoverflow.com/questions/4119018/how-to-make-a-bookmarklet-that-will-turn-selected-text-into-a-link */
    /* http://www.minifier.org/ */

    var itrans = window.getSelection().toString();
    var iast = Sanscript.t(itrans, 'itrans', 'iast');
    var output = iast.split('');
    ...
    replaceSelection(output.join(''), false);
  }
)()
